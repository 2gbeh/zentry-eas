      ...
      <fieldset>    
        <table class="tmp-grid" border="0">
        	<tr>
              ...
              <input type="search" name="card_no" value="<?php echo $_POST['card_no']; ?>" placeholder="Ex. 11252" maxlength="6" list="hint_card" onChange="autof_card(this.value)" required />
 	            <?php echo $hint_card; ?>
            </td>
          	<td colspan="1">
          ...
          <tr>
              ...
              <select name="stmt_type" onChange="autof_stmt(this.value)" required>
                <option></option>
                <?php echo $ddl_stmt; ?>
              </select>
            </td>
          ...
          <tr>
              ...
              <input type="number" name="debit" value="<?php echo  alt_f($_POST['debit']); ?>" onChange="autof_dr(this.value)" <?php echo $disable_dr; ?> />
            </td>
          	<td colspan="1">
              <label>Credit Amount:</label>
              <input type="number" name="credit" value="<?php echo  alt_f($_POST['credit']); ?>" onChange="autof_cr(this.value)" <?php echo $disable_cr; ?> />
            </td>            
          	<td colspan="1">
